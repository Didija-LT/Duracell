...
<body>
    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-light">
      ...
      <div class="collapse navbar-collapse" id="navbarSupportedContent">
        <ul class="navbar-nav mr-auto">
          ...
          <li class="nav-item">
            <a class="nav-link" id="inscriver" href="#">inscrivez-vous</a>
          </li>
          <li class="nav-item">
  ...
  <a href="profil.php">bonjour</a>

   
  <form action="inscription.php" method="POST" class="inscri">
      ...
      $connect= mysqli_connect("localhost","root","","boutique");
           if (isset($_POST['inscription'])) {
            ...
            if(!empty($pseudo) && !empty($nom) && !empty($prenom)&& !empty($email) && !empty($pass) && !empty($ville) && !empty($code_postal) && !empty($adresse) ){
                ...
                VALUES ('".$pseudo."', '".$nom."', '".$prenom."', '".$email."', '".$pass."', '".$ville."', '".$code_postal."', '".$adresse."')";
