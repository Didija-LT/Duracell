...
<body>
  ...
  <centre>
  <h1 class="creer" align="center"> connecter</h1>
  </centre>
  ...
  <form  method="POST">
     ...
     <div class="form-inscrpt ">
      ...
      <input type="submit" class="btn btn-primary col-sm-3 col-form-label" name="connexion" value="connecter">
  ...
  <footer>
    <div class="conteneur">    
        <?php echo date('Y'); ?> - Tous droits reservés - Duracell.
    </div>
</footer>
...
<?php
try{
  $cnx=new PDO("mysql:host=localhost;dbname=boutique","root","");
}
catch(Exception $e){
  die("erreur".$e);
}
 ...
 // Vérifie qu'il provient d'un formulaire
   if (isset($_POST['connexion'])) {
     if(isset($_POST['pseudo']) and isset($_POST['pass'])){
       $trouve=false;
      $reponse=$cnx->query("select * from client where pseudo='".$login."' and password='".$pwd."'  ");
